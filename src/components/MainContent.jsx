...
import ClaudeFlowTab from './ClaudeFlowTab';
  ...
  return (
    <div className="h-full flex flex-col">
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">
                    {activeTab === 'files' ? 'Project Files' : 
                     ...
                     activeTab === 'analytics' ? 'Analytics' : 'Project'}
                  </h2>
                  <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                    {selectedProject.displayName}
                  </div>
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className={`h-full overflow-hidden ${activeTab === 'analytics' ? 'flex' : 'hidden'}`}>
          <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-2">
              <div className="flex space-x-4">
                ...
                <button
                  onClick={() => setAnalyticsView('alerts')}
                  className={`px-3 py-1.5 text-sm font-medium rounded-md ${
                    analyticsView === 'alerts'
                      ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300'
                      : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white'
                  }`}
                >
            ...
            <div className="flex-1 overflow-auto">
              ...
              {analyticsView === 'alerts' && <AlertsManager />}
              {analyticsView === 'reports' && <ReportGenerator />}
            </div>
          </div>
        </div>
        <div className={`h-full overflow-hidden ${activeTab === 'flow' ? 'block' : 'hidden'}`}>
          <ClaudeFlowTab projectPath={selectedProject?.path} />
        </div>
